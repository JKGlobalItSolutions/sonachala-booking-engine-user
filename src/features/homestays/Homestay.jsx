...
function HomestayPage() {
  ...
  return (
    <div className="homestay-page-container">
      {/* Hero Section */}
      <section className="homestay-hero" style={{
        backgroundImage: `url(${import.meta.env.BASE_URL}assets/img/hero.jpeg)`
      }}>
        <div className="homestay-hero-overlay"></div>
        <div className="homestay-hero-content">
          <h1 className="homestay-hero-title text-white">Pack the whole toybox</h1>
          <p className="homestay-hero-subtitle" style={{ color: '#d8d3d3db' }}>Unwind and stretch out in a vacation home</p>
        </div>
      </section>

      {/* Search Section */}
      <div className="container">
        <div className="homestay-search-wrapper">
          <form onSubmit={handleSubmit} className="homestay-search-box">
